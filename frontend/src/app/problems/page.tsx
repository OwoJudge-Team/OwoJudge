  ...
  return (
    <div className="min-h-screen px-4 py-12 md:px-8 bg-background">
      <div className="mx-auto max-w-7xl">
        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl dark:border-slate-800 dark:bg-slate-800">
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/50">
              {problems.map((p, idx) => (
                <tr
                  key={p.id}
                  className="group transition-all duration-150 hover:bg-slate-50 dark:hover:bg-slate-800/50"
                >
                  ...
                  <td className="px-6 py-4">
                    <span className="inline-flex items-center gap-1.5 rounded-lg bg-indigo-50 px-3 py-1.5 text-sm font-medium text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300">
