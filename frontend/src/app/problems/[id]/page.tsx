          ...
          <div className="grid grid-cols-1 gap-4 p-6 sm:grid-cols-3">
            <div className="group rounded-xl border-2 border-blue-100 bg-blue-50/50 p-4 transition-all hover:border-blue-300 hover:shadow-md">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-gray-900">{data.timeLimit} <span className="text-sm text-gray-600">ms</span></p>
                </div>
              </div>
            </div>
            ...
            <div className="group rounded-xl border-2 border-purple-100 bg-purple-50/50 p-4 transition-all hover:border-purple-300 hover:shadow-md">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">Memory Limit</p>
                  <p className="text-xl font-bold text-gray-900">{data.memoryLimit} <span className="text-sm text-gray-600">KB</span></p>
                </div>
              </div>
            </div>
            ...
            <div className="group rounded-xl border-2 border-green-100 bg-green-50/50 p-4 transition-all hover:border-green-300 hover:shadow-md">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">Score Policy</p>
                  <p className="text-xl font-bold text-gray-900 capitalize">{data.scorePolicy}</p>
                </div>
              </div>
            </div>
          </div>
